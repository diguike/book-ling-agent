---
title: 第 3 章 · 工具系统——给 Agent 装上瑞士军刀
feishu_url: "https://fivwvysqdz.feishu.cn/wiki/NSMywyCvOiH123kmkwkc75tZnCd"
...
`openai` 是 LLM 调用库，[`glob`](https://github.com/isaacs/node-glob) 用于文件名匹配工具。[`tsx`](https://tsx.is) 让你直接运行 TypeScript，`typescript` 提供类型检查。
...
| 搜索 | Grep（支持 [ripgrep](https://github.com/BurntSushi/ripgrep) 语法）、Glob（按修改时间排序） |
